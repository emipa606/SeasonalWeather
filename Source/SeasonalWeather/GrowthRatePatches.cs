...
public class GrowthRatePatches
{
    ...
    {
        var harmony = new Harmony("rimworld.whyisthat.seasonalweather.growthrate");
        harmony.Patch(AccessTools.Property(typeof(Plant), nameof(Plant.GrowthRate)).GetGetMethod(), null,
            new HarmonyMethod(typeof(GrowthRatePatches), nameof(GrowRateFactor_Rain)));
    }
